...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		['vs guest'],
		['coolaydang',		'coolay',		'musisan coder and artist yes im the only one here',					'https://www.youtube.com/channel/UCaPW_Sfs7XV3Hv2cNylFOwQ',	0xFFFFFF00],
		['programs used'],
		['lmms',		'lmms',		'Music program',					'https://lmms.io/download#windows',	0xFF06f804],
		['krita',		'krita',		'art program',					'https://krita.org/en/download/krita-desktop/',	0xFFb2daff],
		['SpriteSheetAndXmlGenerator',		'pico!!!!',		'used to make the xmls',					'https://gamebanana.com/tools/download/7136',	0xFF318904],
		['Psych Engine Team'],
